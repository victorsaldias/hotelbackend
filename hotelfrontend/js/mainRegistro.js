...
async function cargarRegiones() {
    try {
        const res = await fetch("https://hotelbackend-5tdjgei3o.onrender.com/api/regiones");
...
async function cargarProvincias(idRegion) {
    ...
    try {
        const res = await fetch(`https://hotelbackend-5tdjgei3o.onrender.com/api/provincias/${idRegion}`);
...
async function cargarComunas(idProvincia) {
    ...
    try {
        const res = await fetch(`https://hotelbackend-5tdjgei3o.onrender.com/api/comunas/${idProvincia}`);
...
async function registrarCliente(e) {
    ...
    const data = {
     ...
     try {
        const res = await fetch("https://hotelbackend-5tdjgei3o.onrender.com/api/clientes/web", {
            method: "POST",
